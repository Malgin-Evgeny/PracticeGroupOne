...
public class ChangeUserConstructor {
    ...
    private Integer freeAccountsNumber;
    private Integer additionalAccountCost;
    ...
    public Integer getFreeAccountsNumber() {
        return freeAccountsNumber;
    }

    public Integer getAdditionalAccountCost() {
        return additionalAccountCost;
    }
    ...
    public void setFreeAccountsNumber(Integer freeAccountsNumber) {
        this.freeAccountsNumber = freeAccountsNumber;
    }

    public void setAdditionalAccountCost(Integer additionalAccountCost) {
        this.additionalAccountCost = additionalAccountCost;
    }
